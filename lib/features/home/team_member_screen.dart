...
// [수정] 팀 멤버를 가져올 때 viewedDeptProvider를 바라보게 하여 팀 변경 시 자동 갱신되도록 합니다.
final teamMembersProvider = FutureProvider.autoDispose<List<Map<String, dynamic>>>((ref) async {
  ...
  return SupabaseRepository().getTeamMembers(viewedDept.id);
});
        ...
        title: PopupMenuButton<Department>(
          ...
          itemBuilder: (context) => Department.values.map((dept) {
            return PopupMenuItem<Department>(
              ...
              child: Row(
                children: [
                  Icon(dept.icon, color: dept.color, size: 18),
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              ...
              viewedDept.color.withOpacity(0.15),
            ],
          ),
        ),
        child: membersAsync.when(
          loading: () => Center(child: CircularProgressIndicator(color: viewedDept.color)),
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: viewedDept.color.withOpacity(0.2),
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(color: viewedDept.color.withOpacity(0.5)),
                        ),
                        child: Text(
                          "${members.length} Active",
                          style: TextStyle(color: viewedDept.color, fontSize: 12, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ],
                  ),
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildMemberTile(context, member, viewedDept);
                    },
                  ),
                ),
              ],
